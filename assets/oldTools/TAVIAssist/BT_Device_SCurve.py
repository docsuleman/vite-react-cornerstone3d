...
class MyWindow(QtWidgets.QMainWindow):
    def closeEvent(self,event):
        if (BT_Device_Scurve_ui.ani):
            BT_Device_Scurve_ui.ani.event_source.stop()
            print("BT DSCurve Plotting Stopped")
        print("DSCurve Show Event")

    def showEvent(self, event):
        if(BTClass.myBT.getConnectedDevice() and BT_Device_Scurve_ui.ani):
            BT_Device_Scurve_ui.ani.event_source.start()
            BT_Device_Scurve_ui.btnGetBTV1.setEnabled(True)
            BT_Device_Scurve_ui.btnGetBTV2.setEnabled(True)
...
class Ui_MainWindow(object):
    ...
    def device_s_cruve_manual(self):
        ...
        self.plot_structure = self.ax.plot(range(-90, 90), self.data, label="Device Plane", color="red")
        self.ax.legend(loc="upper left")
        self.canvas.draw()
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setStyleSheet("image: url(./images/device-scurve-fluoro-title.png);")
        self.label.setText("")
        ...
        self.btnClear = QtWidgets.QPushButton(self.autoBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Device S Curve Maker"))
...
BT_Device_Scurve_ui = Ui_MainWindow()
BT_Device_Scurve_ui.setupUi(MainWindow)
