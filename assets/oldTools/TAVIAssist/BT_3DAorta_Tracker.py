...
class Ui_ThreeDSDSCurve(object):
    ...
    def get_current_pos(self, type):
        ...
        if (self.LAO1 and self.RAO2 and self.CAUD2 and self.CRAN1):
            ...
            self.plot_device = self.ax.plot(range(-90, 90), self.data2, label="S-Curve")
    ...
    def structure_s_cruve(self):
        ...
        if (values):
            ...
            self.data = NAVICath.SCurve_XYZ(int(Lx), int(Ly), int(Lz), int(Rx), int(Ry), int(Rz), int(Nx), int(Ny),
                                            int(Nz))
    ...
    def device_s_cruve(self):
        ...
        self.data2 = NAVICath.get_s_curve_device(xCCV1, xRLV1, xCCV2, xRLV2)
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setStyleSheet("image: url(:/newPrefix/D:/TAVIPIC/QT-NAVICATH/images/AorticTracker.png);")
        self.label.setText("")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./images/aortic-valve.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.val1Box.setTitle(_translate("MainWindow", "Plane 1"))
        ...
        self.xCCV1TextEdit.setPlaceholderText(_translate("MainWindow", "CRAN in Postive, CAUD in Negative"))
        self.val2Box.setTitle(_translate("MainWindow", "Plane 2"))
        ...
        self.xCCV2TextEdit.setPlaceholderText(_translate("MainWindow", "CRAN in Postive, CAUD in Negative"))
        ...
        self.LoadAorta.setText(_translate("MainWindow", "Load Aorta "))
